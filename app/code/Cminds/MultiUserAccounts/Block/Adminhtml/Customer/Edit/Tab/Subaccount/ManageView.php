    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Name'),
                'index' => 'name',
                'renderer' => \Cminds\MultiUserAccounts\Block\Adminhtml\Customer\
                Edit\Tab\Subaccount\Grid\Column\Renderer\Name::class,
            ]
        );
        $this->addColumn(
            'permission',
            [
                ...
                'index' => 'permission',
                'renderer' => \Cminds\MultiUserAccounts\Block\Adminhtml\Customer\
                Edit\Tab\Subaccount\Grid\Column\Renderer\Permission::class,
            ]
        );
        $this->addColumn(
            'is_active',
            [
                ...
                'index' => 'is_active',
                'renderer' => \Cminds\MultiUserAccounts\Block\Adminhtml\Customer\
                Edit\Tab\Subaccount\Grid\Column\Renderer\Status::class,
            ]
        );
