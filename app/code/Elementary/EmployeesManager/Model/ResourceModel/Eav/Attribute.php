...
namespace Elementary\EmployeesManager\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package Elementary\EmployeesManager\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'Elementary_EmployeesManager';
     ...
     * @var string
     */
    protected $_eventPrefix = CustomerEmployeeSetup::ENTITY_TYPE_CODE . '_attribute';
    ...
    protected function _construct()
    {
        ...
        $this->_init(\Elementary\EmployeesManager\Model\ResourceModel\Attribute::class);
    }
