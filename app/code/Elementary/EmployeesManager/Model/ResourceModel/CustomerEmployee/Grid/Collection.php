...
namespace Elementary\EmployeesManager\Model\ResourceModel\CustomerEmployee\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Api\SearchCriteriaInterface;
use Elementary\EmployeesManager\Model\ResourceModel\CustomerEmployee\Collection as CustomerEmployeeCollection;
...
/**
 * Class Collection
 * @package Elementary\EmployeesManager\Model\ResourceModel\CustomerEmployee\Grid
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Collection extends CustomerEmployeeCollection implements SearchResultInterface
{
    /**
    ...
    public function __construct(
        ...
        $eventObject,
        $resourceModel,
        $model = 'Elementary\EmployeesManager\Ui\Component\Listing\DataProvider\Document',
