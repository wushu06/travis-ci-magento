...
class CustomerEmployee extends AbstractEntity
{
    /**
     * Store id
     *
    ...
    public function __construct(
        ...
        $this->setType(CustomerEmployeeSetup::ENTITY_TYPE_CODE);
        $this->setConnection(CustomerEmployeeSetup::ENTITY_TYPE_CODE . '_read', CustomerEmployeeSetup::ENTITY_TYPE_CODE . '_write');
    ...
    /**
     * Retrieve CustomerEmployee entity default attributes
     *
     * @return string[]
     */
