<?php
namespace Elementary\EmployeesManager\Test\Unit\Model\CustomerEmployee;
...
class TestModel extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_model = $this->_objectManager->getObject("Elementary\EmployeesManager\Model\TestModel");
    }
